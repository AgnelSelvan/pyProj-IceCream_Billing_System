...
def admin_login(): 
              root.withdraw()            
              admin1 = Toplevel()
              admin1.title("Ice-Cream Billing System")
              admin1.geometry("400x400+650+250")
              admin1.config(background = "powder blue")
              tf=Frame(admin1,width=400,height=60, padx = 5, pady = 5,background="powder blue",relief='ridge',bd=5)
              tf.place(x=0,y=0)
              lf=Frame(admin1,width=400,height=340,relief="ridge", background="powder blue",bd=5)
              lf.place(x=0,y=60)              
              title=Label(tf,font=("Helvetica",20,"bold"),fg="blue",background = "powder blue", text="Admin Login")
              title.place(x = 100, y = 0)
              l1 = Label(lf,font = ("Helvetica",16,"bold"),bg = "powder Blue",fg = "blue",text = "Username")
              l1.place(x = 60,y = 90)
              l2 = Label(lf,font = ("Helvetica",16,"bold"),bg = "powder Blue",fg = "blue",text = "Password")
              l2.place(x = 60,y = 140)
              admin_entry = StringVar()
              p = StringVar()
              admin_entry.set("")
              p.set("")
              e1 = Entry(lf ,width = 9,font = ("Helvetica",16,"bold"),bd = 5,textvariable = admin_entry)
              e1.place(x = 180,y = 90)
              e2 = Entry(lf ,width = 9,font = ("Helvetica",16,"bold"),bd = 5,show = "*",textvariable = p)
              e2.place(x = 180,y =140)   
              def admin_User():
                     print("hello "+str(admin_entry.get()))
                     if admin_entry.get() == "Admin" and p.get() =="Admin":
                            admin1.withdraw()
                            admin()
                     else:
              ...
              def Home():
                     admin1.withdraw()
                     root.deiconify()
              b1 = Button(lf,font  = ("georgia",15),width = 8,relief = RIDGE,text = "Login",background = "cyan", bd = 5, command = admin_User)
              b1.place(x = 200, y = 200)
              b2 = Button(lf,font  = ("georgia",15),width = 8,relief = RIDGE,text = "Home",background = "cyan", bd = 5,command = Home)
              b2.place(x = 60, y = 200)
...
def bills():
              ...
              billing.geometry("1350x750+150+50")
              billing.config(background = "powder blue")
              ...
              rf3.place(x=0,y=520)             
              title=Label(tf,font=("Helvetica",30,"bold"),fg="blue",background = "powder blue", text="                      A-Z   ICE-CREAMS                           ")
              ...
              def receipt():
                     ...
                     PriceOfItem =(var.get()*30 + var1.get()*35 +var2.get()*20 + var3.get()*10 +var4.get()*30 + var5.get()*35 + var6.get()*40 + var7.get()*80 + var8.get()*50 + var9.get()*45 +var10.get()*50 + var11.get()*70 +var12.get()*60 + var13.get()*90)
                     price = PriceOfItem
                     a = var14.set(price)
                     e14.configure(state = DISABLED)
                     e15.configure(state = NORMAL)
                     GSTOfItem =round(var.get()*30*0.06 + var1.get()*35*0.06 +var2.get()*20*0.06 + var3.get()*10*0.06 +var4.get()*30*0.06 + var5.get()*35*0.06 + var6.get()*40*0.06 + var7.get()*80*0.06 + var8.get()*50*0.06 + var9.get()*45*0.06 +var10.get()*50*0.06 + var11.get()*70*0.06 +var12.get()*60*0.06 + var13.get()*90*0.06)
                     gst = GSTOfItem
                     b = var15.set(gst)
                     ...
                     if ((var.get() or var1.get()  or var2.get() or var3.get() or var4.get() or var5.get() or var6.get() or var7.get() or var8.get() or var9.get() or var10.get() or var11.get() or var12.get() or var13.get()) == 0):
                            txt.configure(state = "disabled")
                            messagebox.showinfo("Waring","Please Entry First")
                     else:
                            txt.configure(state = "normal")
                            txt.insert("1.0","\t      A-Z Ice-Cream\t\t\n")
                            txt.insert(END,"-------------------------------------------------------------\n")
                            ...
                            if y > 0:
                                   ...
                                   messagebox.showinfo("Sucess","Saved Sucessfully!")
              ...
              txt.configure(state='disabled')
              #=============================Receipt Button====================================#
              btnReset = Button(rf3, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 6,width = 6,height=1,bg = 'cyan', text = 'Reset', command = reset).place(x = 0,y = 0)
              btnTotal = Button(rf3, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 6,width = 6,height=1,bg = 'cyan', text = 'Total',command = CostOfItem).place(x = 130,y = 0)
              btnQuit = Button(rf3, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 6,width = 6,height=1,bg = 'cyan', text = 'Quit', command = exit).place(x = 80,y = 60)
              btnReceipt = Button(rf3, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 6,width = 6,height=1,bg = 'cyan', text = 'Receipt', command = receipt).place(x = 260,y = 0)
              btnHome = Button(rf3, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 6,width = 6,height=1,bg = 'cyan', text = 'Home', command = home).place(x = 200,y = 60)
...
def retrival():
       root.withdraw()
       retrival = Toplevel()
       retrival.title("Ice-Cream Billing System")
       retrival.geometry("1350x750+150+50")
       ...
       rf.place(x = 925,y = 0)
       rf1 = Frame(rf,width = 125, height = 50,background = "powder blue",bd  = 6,relief = "ridge",padx = 5,pady = 5)
       rf1.place(x = 5,y = 5)
       title=Label(lf,font=("Helvetica",30,"bold"),fg="blue",background = "powder blue", text="                      A-Z   ICE-CREAMS                           ")
       title.pack(side=LEFT)
       ...
       def history():
              ...
              for i in d:
                            ...
                            txt1.insert(END,"Sub total \t \t ₹"+str(i[15])+"/-\n ")
                            txt1.insert(END,"GST \t \t ₹"+str(i[16])+"/-\n ")
                            txt1.insert(END,"Total cost \t \t ₹"+str(i[17])+"/-\n\n\n\n                      A-Z Ice Cream\n")
              txt1.configure(state = "disabled")
       
      
       #=====================================Button=================================================
       
       sbtn = Button(rf,width = 6,cursor = 'hand2',height = 2,bd = 4,bg = 'cyan',text = 'S',command = search)
       sbtn.place(x = 297, y = 5)
       hBtn = Button(lfd, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 10,width = 15,height= 7,bg = 'cyan', text = 'Home', command = back).place(x = 30,y = 30)
       histBtn = Button(lfd, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 10,width = 15,height= 7,bg = 'cyan', text = 'History',command = history).place(x = 350,y = 30)
       rBtn = Button(lfd, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 10,width = 15,height= 7,bg = 'cyan', text = 'Reset',command = clear).place(x = 650,y = 30)
       qBtn = Button(lfd, padx = 5, pady = 5,fg = "black",cursor = 'hand2', font= ("arial",14,'bold'),bd = 10,width = 15,height= 7,bg = 'cyan', text = 'Quit', command = bye).place(x = 350,y = 300)
       
       #=====================================Label==================================================
       rf1L = Label(rf1,text = "Bill No", font = ("Helvetica",20,"bold"),background = "powder blue")
       rf1L.place(x = 0, y =0)
...
def admin():
              root.withdraw()            
              admin = Toplevel()
              admin.title("Ice-Cream Billing System")
              ...
              t1.place(x = 20, y = 20)
              Qty = Label(lf1a,font = ("Helvetica",18,'bold'), padx = 10, pady = 10,background = 'powder blue',fg = 'blue',text = 'In Stock')
              Qty.place(x = 190, y = 20)
              title=Label(tf,font=("Helvetica",30,"bold"),fg="blue",background = "powder blue", text="                         Admin Page                                 ")
              title.pack(side=LEFT)
              ...
              t2.place(x = 20, y = 20)
              Qty = Label(lf1b,font = ("Helvetica",20,'bold'), padx = 10, pady = 10,fg = 'blue',background = 'powder blue',text = 'In Stock')
              Qty.place(x = 170, y = 20)
              ...
              #=====================def
              def new_table():
                     c.execute("CREATE TABLE IF NOT EXISTS stock(bacon Integer,pista integer,chocolate integer,mango integer,strawberry integer,vanilla integer,blue_moon integer,magnum integer,cornetto integer,kulfi integer,milk_shake integer,choco_top integer,affogato integer,brownie integer)")
                     conn.commit()
              def insert_in_table(x,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13):
                     c.execute("INSERT INTO stock(bacon,pista,chocolate,mango,strawberry,vanilla,blue_moon,magnum,cornetto,kulfi,milk_shake,choco_top,affogato,brownie) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",(x,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13))
                     conn.commit()
              def home():
                     admin.withdraw()
                     root.deiconify()
              ...
              #==============================Button
              rstBtn = Button(lf2, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 10,width = 9,bg = 'cyan',text = 'Reset',command = reset)
              rstBtn.place(x = 50, y = 20)
              updateBtn = Button(lf2, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 10,width = 9,bg = 'cyan', text = 'Update',command = update).place(x = 250,y = 20)
              homeBtn = Button(lf2, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 10,width = 9,bg = 'cyan', text = 'Home',command = home).place(x = 450,y = 20)
              quitBtn = Button(lf2, padx = 5, pady = 5,fg = "black", font= ("arial",14,'bold'),bd = 10,width = 9,bg = 'cyan', text = 'Quit',command = iExit).place(x = 650,y = 20)
...
def Stock(v,v1,v2,v3,v4,v5,v6,v7,v8,v9,v10,v11,v12,v13,v14,v15,v16):
       ...
       if b >= 0 and b1>= 0 and b2>= 0 and b3>= 0 and b4>= 0 and b5>= 0 and b6 >= 0  and b7 >= 0 and b8 >= 0 and b9 >= 0 and b10 >= 0 and b11 >= 0 and b12 >= 0 and b13 >= 0 :
                     c.execute("INSERT INTO stock(bacon,pista,chocolate,mango,strawberry,vanilla,blue_moon,magnum,cornetto,kulfi,milk_shake,choco_top,affogato,brownie) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?)",(b,b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13))


                     billing1 = Toplevel()
                     billing1.title("Ice-Cream Billing System")
                     billing1.geometry("1350x750+150+50")
                     billing1.config(background = "powder blue")
                     tf=Frame(billing1,width=900,height=100, padx = 5, pady = 5,background="powder blue",relief='ridge',bd=10)
                     tf.place(x=0,y=0)
                     lf=Frame(billing1,width=900,pady = 10,height=650,relief="ridge", background="powder blue",bd=10)
                     lf.place(x=0,y=100)
                     lf1a=Frame(lf,width=450,height=500,relief="ridge", background="powder blue",bd=10)
                     lf1a.place(x=0,y=10)
                     lf1b=Frame(lf,width=430,height=500,relief="ridge", background="powder blue",bd=10)
                     ...
                     lf2=Frame(lf,width=880,height=125,relief="ridge", background="powder blue",bd=10)
                     lf2.place(x=0,y=475)
                     rf=Frame(billing1,width=450,height=750,padx = 10,pady = 30 ,relief="ridge", background="powder blue",bd=10)
                     rf.place(x=900,y=0)
                     rf1=Frame(rf,width=200,height=100,relief="ridge", background="powder blue",bd=10)
                     rf1.place(x=0,y=0)
                     rf2=Frame(rf,width=400,height=500,padx = 10, pady = 10,relief="ridge", background="white",bd=10)
                     ...
                     def receipt():
                            ...
                            if ((var.get() or var1.get()  or var2.get() or var3.get() or var4.get() or var5.get() or var6.get() or var7.get() or var8.get() or var9.get() or var10.get() or var11.get() or var12.get() or var13.get()) == 0):
                                   ...
                                   txt.insert(END,"Total cost \t \t ₹"+str(var16.get())+"/-\n ")
                                   txt.configure(state='disabled')
                                   x = messagebox.askyesno("Ice-Cream Billing System","Want to save?")
                                   if x > 0:
                                          create_table()
                                          v  = var.get()
                                          v1 = var1.get()
...
rimg = PhotoImage(file = "info.png")



root.title("Ice-Cream Billing System")
root.geometry("1350x750+150+50")

top = Frame(root, width = 1330,height = 100, bd = 10, relief  = "ridge", padx = 10, pady = 10)
top.place(x = 10, y = 10)
title = Label(top,font = ("Helvetica",52,"bold"),fg = "blue",text = "            Ice Cream Billing System            ")
title.pack() 

billBtn = Button(root,height = 10,font  = ("georgia",15),cursor = "hand2",width = 47,relief = RIDGE,pady = 5, padx = 5 , text = "Billing System",background = "cyan", bd = 10, command = bills)
billBtn.place(x = 40, y = 150)
billBtn.bind('<Enter>',billcolor1)
billBtn.bind('<Leave>',billcolor2)

RetrivalBtn = Button(root,height = 10,font  = ("georgia",15),width = 47,relief = RIDGE,pady = 5, padx = 5 , text = "Retrival System",background = "cyan", bd = 10, command = retrival)
...
def quit():
       ...
       if Quit>0:
              root.destroy()
ExitBtn = Button(root,height = 7,font  = ("georgia",15),cursor = "hand2",width = 65,relief = RIDGE,pady = 5, padx = 5 , text = "Exit System",background = "cyan", bd = 10,command = quit)
ExitBtn.place(x = 260, y = 475)
ExitBtn.bind('<Enter>',closecolor1)
ExitBtn.bind('<Leave>',closecolor2)

adminBtn = Button(top, height  = 4,width = 10,bd = 7,relief = RIDGE,font = ("georgia",10,"bold"),text = "Admin" ,background = "cyan",command = admin_login)
